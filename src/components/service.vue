  ...
  data: function () {
    return {
      ...
      additional_spd_items: [
        { title: "Register to access the Support Provider Directory", text: "Register with your CAC (DoD Common Access Card) to search thousands of existing support organizations. Additionally, registered users will be able to request changes to existing support provider and commodity records.", btn_title: "Register", link: "https://ds-itsmweb.dc3n.navy.mil/arsys/forms/supportapp/A_SDE+ECRM+Directory+Management+Console/" },
