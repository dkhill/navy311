            ...
            <template v-if="$vuetify.breakpoint.smAndUp">
                <v-card>
                    <v-toolbar flat color="#072F5F" dark>
                        <v-toolbar-title>
                            <h4 class="toolTitle">Flank Speed Environment</h4>
                        </v-toolbar-title>
                    </v-toolbar>
                        ...
                        <v-row>
                            <v-col cols="12">
                                <v-card>
                                    <v-toolbar flat color="#072F5F" dark>
                                        <v-toolbar-title>
                                            <h4 class="toolTitle">Flank Speed Support</h4>
                                        </v-toolbar-title>
                                    </v-toolbar>
                                    <div class="card-margin">
                                        <p class="card-paragraph" style="text-align: center;">For Flank Speed (FS) support, contact your network service desk (NMCI, One-NET, RDT&E, etc.)</p>
                                        <div style="text-align: center;">If you need to check the status of your request, please contact the network service desk that you submitted the request to.
                                            <p />
                                        </div>
                                        <div style="font-weight: 600; text-align: center;">NOTE: The NMCI Status Checking Tool can only be accessed from an NMCI Computer.
                                            <p />
                                        </div>
                                        <v-row>
                                            <v-col cols="6">
                        ...
                        <v-row>
                            <v-col cols="12">
                                <v-card class="cvr-support-card">
                                    <v-toolbar flat color="#072F5F" dark>
                                        <v-toolbar-title>
                                            <h4 class="toolTitle">Flank Speed Login Guide</h4>
                                        </v-toolbar-title>
                                    </v-toolbar>
                                    <div class="page_container">
                        ...
                        <v-row>
                            <v-col cols="12">
                                <v-card>
                                    <v-toolbar flat color="#072F5F" dark>
                                        <v-toolbar-title>
                                            <h4 class="toolTitle">Flank Speed FAQ's</h4>
                                        </v-toolbar-title>
                                    </v-toolbar>
                                    <div class="card-margin">
                ...
                <v-row>
                    <v-col cols="12">
                        <v-card class="cvr-support-card">
                            <v-toolbar flat color="#072F5F" dark>
                                <v-toolbar-title>
                                    <h4 class="toolTitle">Login Guide</h4>
                                </v-toolbar-title>
                            </v-toolbar>
                            <div class="page_container">
                                <p class="card-paragraph">NOTE: Access to Flank Speed is dependent on a properly realigned PIV Authentication certificate. As of 24 February 2018, all Navy-issued CACs have an active PIV Authentication certificate. All users with CACs issued before 24 February 2018 must activate their PIV Authentication certificate. If you have questions or need instructions how to verify or activate your PIV, please go to:</p>
